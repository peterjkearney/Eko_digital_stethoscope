...
RAW_DATA_PATH        = DATA_DIR / 'audio_and_txt_files_CLEANED'
...
SPECTROGRAMS_DIR = (
    ...
    if _in_colab()
    else BASE_DIR / 'data' / 'spectrograms'
)
...
RESNET_VARIANT     = 'resnet34'   # 'resnet18', 'resnet34', or 'resnet50'
...
# Backbone freezing
# Freeze all ResNet layers up to and including this layer name.
# None     = train the full backbone
# 'layer2' = freeze conv1, bn1, layer1, layer2  (~6% of backbone params frozen)
# 'layer3' = freeze conv1, bn1, layer1, layer2, layer3  (~25% frozen)
# 'layer4' = freeze entire backbone  (~100% frozen)
