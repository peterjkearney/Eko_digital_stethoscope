...
from dataset import ICBHIDataset, get_dataloaders, IDX_TO_LABEL
...
def evaluate(
    ...
    """Run inference over loader and return ICBHI metrics."""
    model.eval()
...
def train_run(
    ...
    eval_name    = 'Val' if 'val' in loaders else 'Test'
    ...
    for epoch in range(start_epoch, num_epochs + 1):
        ...
        row = {
            ...
            **{f'train_{k}': v for k, v in train_metrics.items()},
            f'{eval_name.lower()}_icbhi':          score,
            f'{eval_name.lower()}_mean_se':        eval_metrics['mean_sensitivity'],
            f'{eval_name.lower()}_mean_sp':        eval_metrics['mean_specificity'],
        }
        history.append(row)
        ...
        if score > best_score:
            ...
            print(f"  ✓ New best ICBHI {score:.4f} — checkpoint saved.")
    ...
    print(f"\n{run_name} complete — best ICBHI {best_score:.4f} at epoch {best_epoch}.")
