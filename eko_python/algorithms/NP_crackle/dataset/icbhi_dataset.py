...
IDX_TO_LABEL = {0: 'normal', 1: 'crackle'}
...
class ICBHIDataset(Dataset):
    ...
    fraction      : fraction of a patient's samples to use. Only used for reducing
                    size of dataset for quick parameter validation
    """
    ...
    def get_class_weights(self) -> torch.Tensor:
        ...
        """
        counts = self.manifest['crackle'].value_counts()
        weights = []
        labels = [0,1]
        for label in labels:
